        ...
        <>
          ...
          <div className="overlay">
            {trainings.map((training, index) => {
              return <CardTraining training={training} />;
            })}
          </div>
        </>
      );
      ...
      <>
        ...
        <div className="slider">
          ...
          <div className="button-slider">
            <SliderControlPrimary className="next-secondary" id="prev-category">
            ...
            <SliderControlPrimary className="next-secondary" id="next-category">
              <svg
                width="10"
                height="18"
                viewBox="0 0 10 18"
